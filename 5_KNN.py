...
iris= pd.read_csv(r'D:\ML\5_DecisionTID3/iris.csv') # Import the iris.csv dataset
...
print(Y_test.shape) #Display the dimensions of Y_test
...
print("prediction values are",pred_output.transpose())
